    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_acmMgr.Article", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_acmMgr.File", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_acmMgr.Problem", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_acmMgr.Contest_acmMgr.Article_DescriptionId",
                        column: x => x.DescriptionId,
                        principalTable: "acmMgr.Article",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_acmMgr.Contest_acmMgr.Article_ResultId",
                        column: x => x.ResultId,
                        principalTable: "acmMgr.Article",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AbpUsers_acmMgr.File_PhotoId",
                        column: x => x.PhotoId,
                        principalTable: "acmMgr.File",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateTable(
                name: "acmMgr.Certificate",
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_acmMgr.Certificate_acmMgr.File_FileId",
                        column: x => x.FileId,
                        principalTable: "acmMgr.File",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_acmMgr.ContestSignUp_acmMgr.Contest_ContestId",
                        column: x => x.ContestId,
                        principalTable: "acmMgr.Contest",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_acmMgr.Certificate_FileId",
                table: "acmMgr.Certificate",
                column: "FileId");

            migrationBuilder.CreateIndex(
                name: "IX_acmMgr.Comment_ArticleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_acmMgr.Contest_DescriptionId",
                table: "acmMgr.Contest",
                column: "DescriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_acmMgr.Contest_ResultId",
                table: "acmMgr.Contest",
                column: "ResultId");

            migrationBuilder.CreateIndex(
                name: "IX_acmMgr.ContestSignUp_ContestId",
