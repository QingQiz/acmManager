...
namespace acmManager.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        ...
        public HostRoleAndUserCreator(acmManagerDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            if (adminRoleForHost == null)
            {
                adminRoleForHost = _context.Roles.Add(new Role(
                    ...
                    StaticRoleNames.Host.Admin) { IsStatic = true, IsDefault = false }).Entity;
            ...
            if (adminUserForHost == null)
            {
                var user = new User
                {
                    ...
                    Name = "admin",
                    Surname = "admin",
                    EmailAddress = "sofeeys@outlook.com",
