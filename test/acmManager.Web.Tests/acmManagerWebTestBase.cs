...
{
    public abstract class acmManagerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static acmManagerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(acmManagerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<acmManagerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<acmManagerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<acmManagerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<acmManagerDbContext, Task<T>> func)
        {
            T result;
